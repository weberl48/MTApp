...
export const EDIT_SERVICE_TYPE_WALKTHROUGH: Walkthrough = {
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'The Services tab shows all your service types with their pricing summary. We\'ll open the first one so you can see all the fields available to you.',
    ...
    {
      title: 'Save and Test',
      description: 'Click "Save Changes" to apply your edits. Changes only affect new sessions — existing records are not changed. Use View As mode to check that contractors see the right service types and pricing. You can close this form now.',
      ctaLabel: 'Finish',
      href: '/settings/business/',
    },
  ],
