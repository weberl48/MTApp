...
export const INVITE_CONTRACTOR_WALKTHROUGH: Walkthrough = {
  ...
  steps: [
    ...
    },
    {
      ...
      audience: 'owner',
      description: 'The Rates tab shows every contractor\'s pay per service — view-only; editing lives in Settings > Pricing.',
...
export const CONFIGURE_SERVICES_WALKTHROUGH: Walkthrough = {
  ...
  // Owner-only: the Pricing hub it tours carries contractor pay config.
  audience: 'owner',
  steps: [
    {
      title: 'Go to Settings',
      description: 'Service pricing lives in Settings > Pricing.',
      element: 'nav a[href="/settings/"]',
      popoverSide: 'right',
      ctaLabel: 'Next',
    ...
    },
    {
      ...
      description: 'This table lists every service type with its base rate, per-person rate, total cap, and scholarship rate. Click any cell to edit it in place. Each row also has a pencil to edit the service\'s identity and a trash icon to delete it.',
    ...
    {
      title: 'Add a Service',
      description: 'Click "Add Service" to create a new service type. Creating one asks for name, category, location, base rate, and MCA % — everything else, like caps and pay schedules, is edited afterward right in the tables.',
    ...
    },
    {
      ...
      description: 'For a step-by-step guide through every table and field on this page, take the "Edit a Service Type" tour — you\'ll find it in the Help Center\'s Guided Tours list. It highlights each piece and explains what it does.',
      ctaLabel: 'Finish',
      href: '/settings/pricing/',
    },
  ],
...
export const EDIT_SERVICE_TYPE_WALKTHROUGH: Walkthrough = {
  ...
  steps: [
    {
      title: 'Go to Settings',
      description: 'Service types are configured under Settings > Pricing. This tour walks through every table on the page, then the fields that remain in the service dialog — it takes about 3 minutes.',
      element: 'nav a[href="/settings/"]',
      ctaLabel: 'Next',
      href: '/settings/pricing/',
      mobileNav: true,
    ...
    {
      title: 'What the Client Pays',
      description: 'This table\'s cells are click-to-edit: base rate, per-person rate, total cap, and scholarship rate all live here now, not in a dialog.',
      element: '[data-tour="pricing-billing-table"]',
      popoverSide: 'top',
      ctaLabel: 'Next',
      href: '/settings/pricing/',
    ...
    {
      title: 'Group Pay by Headcount',
      description: 'For group services, set exact contractor pay by headcount (1 through "6+") and duration — the same idea as the pay schedule above, but keyed to how many clients attended. Leave a cell empty to fall back to the pay schedule or formula for that combination.',
      element: '[data-tour="pricing-group-pay"]',
      popoverSide: 'bottom',
      ctaLabel: 'Next',
      href: '/settings/pricing/',
    },
    {
      ...
      description: 'MCA % is editable right in this table now — no more service silently saving at 0%. Contractor Cap sits next to it, and Margin @ Base shows a read-only preview of what the organization keeps on a base-duration session.',
    ...
    },
    {
      ...
      description: 'We\'ve opened your first service so you can see the fields that still live in this dialog — name, category, behavior toggles, and contractor restrictions. We\'ll go through them one by one.',
      ctaLabel: 'Next',
      href: '/settings/pricing/?tour=edit-service',
    },
    {
      title: 'Service Name',
    ...
    },
    {
      ...
      description: 'When on, sessions using this service type are batch-invoiced monthly on the Scholarship tab instead of generating individual invoices. Pair this with the Scholarship Rate in the client-pays table.',
    ...
    {
      title: 'Save and Test',
      description: 'Click "Save Changes" to apply. Changes only affect new sessions — existing sessions keep their original pricing. To move already-logged sessions onto the new numbers, use Recalculate pricing on the Sessions page (there\'s a separate tour for it). Use View As mode to confirm contractors see the right options. You can close the form now.',
      ctaLabel: 'Finish',
      href: '/settings/pricing/',
    },
  ],
...
export const CONTRACTOR_RATES_WALKTHROUGH: Walkthrough = {
  ...
  // Owner-only: the Pricing hub section this tour walks through is hidden from admins.
  audience: 'owner',
  steps: [
    {
      title: 'Go to Settings',
      description: 'Custom pay rates live in Settings > Pricing now.',
      element: 'nav a[href="/settings/"]',
      popoverSide: 'right',
      ctaLabel: 'Next',
      href: '/settings/pricing/',
    ...
    {
      title: 'What the Contractor Earns',
      description: 'This card holds everything about contractor pay: the pay schedule, the group pay matrices, and — at the bottom — the per-contractor override matrix we\'re about to look at.',
      element: '[data-tour="pay-rate-matrix-section"]',
      popoverSide: 'top',
      ctaLabel: 'Next',
      href: '/settings/pricing/',
    },
